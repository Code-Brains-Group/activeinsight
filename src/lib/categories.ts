...
export const categories: Category[] = [
  ...
  },
  {
    ...
    image: catCosmetics,
    items: [
      { name: "Zaron Foundation Range", desc: "Full-coverage foundations matched to deep skin tones.", image: cosFoundation },
      { name: "House of Tara Lipsticks", desc: "Long-wear matte and satin Nigerian lipstick shades.", image: cosLipsticks },
      { name: "Arami Essentials Skincare", desc: "Clean, plant-based skincare from Lagos.", image: cosSkincare },
      { name: "Orïkì Body Butters", desc: "Whipped natural body butters in signature scents.", image: cosBodyButter },
      { name: "Nigerian Perfume Oils", desc: "Concentrated attars and oud-based fragrance oils.", image: cosPerfume },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Moringa Powder", desc: "Nutrient-rich moringa leaf powder, 250g packs.", image: orgMoringa },
      { name: "Honey & Bee Products", desc: "Raw forest honey and beeswax in bulk.", image: orgHoney },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Ankara Print Handbags", desc: "Structured handbags in vibrant Ankara prints.", image: jewHandbag },
    ],
  },
  {
    slug: "rtw-fashion",
