...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Admin fee from KES 1,500. Cargo rate KES 1,000 per KG. Request a custom quote." },
...
function Pricing() {
  return (
    <>
      <PageHero eyebrow="Pricing" title="Transparent and fair." intro="Our pricing is straightforward — an admin fee plus a per-kilo cargo rate. Custom quotes available for bulk orders." />
      <section className="container-luxe py-20">
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-card border border-border p-10 hover:border-gold transition-colors">
            <p className="text-xs uppercase tracking-[0.3em] text-gold">Admin Fee</p>
            <p className="font-serif text-5xl text-ink mt-4">From KES 1,500</p>
            <p className="text-muted-foreground mt-3">Covers sourcing coordination, vendor liaison and verification work.</p>
          ...
          <div className="bg-ink text-cream p-10 shadow-luxe relative overflow-hidden">
            ...
            <p className="font-serif text-5xl text-gold mt-4 relative">KES 1,000 <span className="text-2xl text-cream/70">/ KG</span></p>
            <p className="text-cream/70 mt-3 relative">Cross-border shipping, customs handling and delivery to Kenya.</p>
        ...
        <div className="text-center mt-12 flex flex-wrap justify-center gap-4">
          ...
          <a href="https://wa.me/254700000000" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 border border-ink text-ink px-8 py-3.5 hover:bg-ink hover:text-cream transition-colors">
